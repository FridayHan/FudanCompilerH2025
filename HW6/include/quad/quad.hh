...
public:
  ...
  int last_label_num;
  int last_temp_num;
  QuadFuncDecl(Tree *node, string funcname, vector<Temp *> *params,
               vector<QuadBlock *> *quadblocklist, int lln, int ltn)
...
public:
  ...
  QuadBlock(Tree *node, vector<QuadStm *> *quadlist, Label *entry_label,
            vector<tree::Label *> *exit_labels)
...
public:
  ...
  vector<QuadTerm *> *args;
  TempExp *result_temp;
  QuadExtCall(Tree *node, TempExp *result_temp, string extfun,
...
public:
  TempExp *dst;
  QuadExtCall *extcall;
  QuadMoveExtCall(Tree *node, TempExp *dst, QuadExtCall *extcall,
                  set<Temp *> *def, set<Temp *> *use)
...
public:
  ...
  QuadTerm *right;
  Label *t, *f;
  QuadCJump(Tree *node, string relop, QuadTerm *left, QuadTerm *right, Label *t,
