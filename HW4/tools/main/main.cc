...
int main(int argc, const char *argv[]) {
    ...
    //tree::Program *ir = ast2tree(root, semant_map); //**** YOU ARE TO CODE THIS FUNCTION */
...
/* The following IR is for testing output to XML. 
   It roughly corresponds to the following program:
