...
class Type; // members: typeKind, cid, arity. including all types: class, int,
            // array with and without arity.
class VarDecl;    // members: type, id, init (a variant). Including all types:
                  // class, int, array with and without arity
class MethodDecl; // members: type, id, fl, vdl, sl. Including all types: class,
                  // int, array with and without arity
...
public:
  ...
  std::string print() {
    return "Position(sline: " + std::to_string(sline) +
           ", scolumn: " + std::to_string(scolumn) +
           ", eline: " + std::to_string(eline) +
